    ...
    <main className="bg-background text-foreground">
      ...
      <ArticleSection>
        <ArticleFlow>
          ...
          <p>
            {nbsp("Форма конечно важна, но не критична. Это может быть доска Miro, где стикерами формируем ход мыслей. Может быть блокнот, или тетрадь. Да хоть рисунки — главное понять, как вы в принципе планируете жизнь и думаете о ней. А финансовый план уже подстраивается под ваш ход мыслей.")}
          </p>
          <p>
      ...
      <ArticleSection id="stress-test">
        ...
        <ArticleFlow className="mt-6 md:mt-8">
          ...
          <p>
            {nbsp("Как-то ко мне пришёл клиент с вопросом: «Куда мне вложить 18 млн?» Он перебирал недвижимость, облигации, акции, фонды, крипту — хотел всё диверсифицировать и сделать максимально грамотно. А потом мы начали собирать финансовый план, и выяснилось, что в ближайшие несколько лет эти деньги уже расписаны: квартира побольше через 2–3 года, университет для старшего ребёнка ещё через четыре, и собственный бизнес, который он всерьёз хотел запустить.")}
          </p>
        </ArticleFlow>
        <Figure
          src={stress3Img}
        ...
        <ArticleFlow className="mt-6 md:mt-8">
          <p>
            {nbsp("И внезапно оказалось, что инвестиционного капитала у него нет: деньги уйдут — не на одно, так на другое. Инвестировать можно только остаток, если он вообще останется.")}
          </p>
          <Pull>
        ...
        <ArticleFlow className="mt-6 md:mt-8">
          ...
          <p>
            {nbsp("Наверное, самый странный вопрос для статьи про капитал. Но иногда лучший способ распорядиться деньгами — не инвестировать их вообще. Потратить миллион на образование, которое заметно увеличит доход. Вложиться в собственный бизнес. Купить квартиру и убрать огромную статью будущих расходов. Взять полгода без работы, потратить больше на здоровье или на путешествия с детьми сейчас, а не когда им будет 25 лет.")}
          </p>
        </ArticleFlow>
        <Figure
          src={stress5Img}
