              ...
              <div className="container-px max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 gap-2">
                  {pageReviews.map((r, i) => (
                    <figure
                      key={i}
                      className="grid grid-cols-1 gap-4 border border-foreground/15 bg-card p-4 md:gap-5 lg:grid-cols-[30fr_24fr_46fr]"
                    >
                      ...
                      <div className="min-w-0 border-t border-foreground/10 pt-4 md:col-span-1 lg:border-l lg:border-t-0 lg:pl-5 lg:pt-0">
