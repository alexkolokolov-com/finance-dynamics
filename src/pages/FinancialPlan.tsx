    ...
    <main className="bg-background text-foreground">
      ...
      <ArticleSection id="stress-test">
        <ArticleFlow>
          ...
          <p>
            {nbsp("Очень часто уже на этом этапе оказывается, что никаких «5 млн для инвестиций» у вас нет. Есть 1 млн резерва, 3 млн на квартиру через три года и ещё 2 млн действительно долгосрочного капитала. Относиться к этим трём суммам одинаково — довольно странно.")}
          </p>
