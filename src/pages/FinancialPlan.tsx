    ...
    <main className="bg-background text-foreground">
      ...
      <ArticleSection id="stress-test">
        ...
        <ArticleFlow className="mt-6 md:mt-8">
          ...
          <p>
            {nbsp("10 млн рублей могут быть одновременно и большой суммой, и совершенно недостаточным капиталом. Как-то ко мне пришёл клиент с вопросом: «Куда мне вложить 18 млн?» Он рассматривал недвижимость, облигации, акции, фонды, крипту — хотел всё диверсифицировать и сделать максимально грамотно. А потом мы начали собирать финансовый план, и выяснилось, что:")}
          </p>
          <ul className="list-disc pl-5">
            ...
            <li>{nbsp("а сам он работает в найме и всерьёз думает уйти и запустить собственный бизнес.")}</li>
          </ul>
          <p>
            {nbsp("И внезапно оказывается, что никакого инвестиционного капитала у него нет: в ближайшие пять лет эти деньги уйдут — не на одно, так на другое. Инвестировать можно только остаток.")}
          </p>
          <Pull>
