        ...
        <div className="mx-auto max-w-[1400px] text-center">
          ...
          <h1 aria-label="После 40 жизнь может стать лучше" className="mx-auto mt-8 max-w-7xl font-display text-[clamp(2.7rem,7.3vw,7rem)] font-semibold leading-[0.93] sm:mt-12">
            ...
            <span className="mt-1 block whitespace-nowrap">
              ...
              <span
                aria-hidden="true"
                className={`longevity-typewriter mt-1 block min-h-[0.93em] text-left text-muted-foreground sm:ml-[0.13em] sm:mt-0 sm:inline-block sm:min-w-[4.8em] ${headlineIsFinal ? "longevity-typewriter-final text-accent" : ""}`}
              >
                {headlineWord}
              </span>
            </span>
